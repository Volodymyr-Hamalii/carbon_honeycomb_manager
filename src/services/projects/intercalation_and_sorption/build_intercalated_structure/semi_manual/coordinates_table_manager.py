...
from src.services import Constants, ConstantsAtomParams, Logger, FileReader, FileWriter, PathBuilder
...
class CoordinatesTableManager:
    ...
    def update_full_channel_tbl_file(
        ...
        inter_channel_coordinates: IPoints = InterAtomsParser.parse_inter_atoms_coordinates_df(
