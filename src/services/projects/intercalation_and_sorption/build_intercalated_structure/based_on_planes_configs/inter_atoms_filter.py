...
from src.services import Logger, execution_time_logger, DistanceMeasurer, ConstantsAtomParams
...
class InterAtomsFilter:
    ...
    def replace_nearby_atoms_with_one_atom(
        ...
        dist_matrix_upd: np.ndarray = DistanceMeasurer.calculate_dist_matrix(inter_atoms_upd.points)
