...
from src.services import Logger, execution_time_logger, DistanceMeasurer, ConstantsAtomParams, CarbonHoneycombChannel
...
class InterAtomConfigurator:
    ...
    def space_inter_atoms_equidistantly(
        ...
        while True:
            dist_matrix: np.ndarray = DistanceMeasurer.calculate_dist_matrix(inter_points_upd.points)
