...
from src.interfaces import ICarbonHoneycombChannel, IPoints, PCoordinateLimits
from src.services import Logger, DistanceMeasurer, PointsFilter
...
class InterAtomsFilter:
    ...
    def get_filtered_atoms_atoms(
        ...
        if num_of_atoms > max_atoms:
            ...
            if current_min_dist < min_dist_between_atoms_sum_prev:
                ...
                # Check variance
                current_min_dist_sum: floating = DistanceMeasurer.calculate_min_distance_sum(
    ...
    def filter_atoms_related_carbon(
        ...
        limits: PCoordinateLimits = carbon_channel.coordinate_limits
    ...
    def _filter_atoms_relates_carbon_atoms(
        ...
        filtered_atoms_coordinates: IPoints = Points(
