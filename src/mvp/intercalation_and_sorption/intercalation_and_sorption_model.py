...
class IntercalationAndSorptionModel(GeneralModel, IIntercalationAndSorptionModel):
    ...
    def get_available_files(self, project_dir: str, subproject_dir: str, structure_dir: str) -> list[str]:
        ...
        try:
            # Include CSV and legacy coordinate formats.
            ...
            csv_files: list[str] = FileReader.read_list_of_files(result_data_path, format=".csv", to_include_nested_files=True)
            ...
            # Combine both lists
            files: list[str] = sorted(csv_files + xlsx_files + dat_files)
